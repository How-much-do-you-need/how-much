...
const itemDummyData = {
    ...
    imgUrl: "https://images.unsplash.com/photo-1602174528367-7ed9fc0737e4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",
    price: 369000,
        ...
        <ItemContainer>
            <ItemInnerContainer>    
                ...
                <ItemIinfoContainer>
                    ...
                    <ItemPrice>
                        <CurrentPrice>희망 가격: <CurrentPriceSpan color={priceColor}> {parseInt(item.price).toLocaleString()}원</CurrentPriceSpan></CurrentPrice>
                        <PriceBtnDiv>
